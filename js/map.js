 ...
 * map.js
 * Purpose:
 *   Location tab map support:
 *   - Leaflet map initialization
 *   - Geocoding helper (end-user triggered search)
 *   - Marker placement + map centering
 * Notes:
 *   If you scale usage, consider swapping geocoding/tiles to a paid provider
 *   or your own hosted service to comply with usage policies.
 */
